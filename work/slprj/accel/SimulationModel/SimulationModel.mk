...
MAKECMD         = /Applications/MATLAB_R2015b.app/bin/maci64/gmake
HOST            = UNIX
BUILD           = yes
...
MODULES            = SimulationModel_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = SimulationModel.mk
MATLAB_ROOT        = /Applications/MATLAB_R2015b.app
ALT_MATLAB_ROOT    = /Applications/MATLAB_R2015b.app
MASTER_ANCHOR_DIR  = 
START_DIR          = /Users/gabrieldittrick/MATLABWORK/CompetRobot/work
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/SimulationModel \
	-I$(START_DIR) \
	-I/Users/gabrieldittrick/MATLABWORK/CompetRobot/model \
...
$(PROGRAM) : $(OBJS) $(SHARED_LIB) $(LIBS)
	@echo "### Linking ..."
	$(CC) $(MEX_FLAGS) -MATLAB_ARCH=$(ARCH) -silent -outdir $(RELATIVE_PATH_TO_ANCHOR) $(LINK_OBJS) $(SHARED_LIB) $(LIBS) $(MATHLIBS) $(LIBSLFILEIO) $(LIBSLIOFILE) $(LIBSIGSTREAM) $(LIBMWSL_ASYNCIO) $(LIBMWSLEXEC_SIMBRIDGE) $(LIBSIMULINK)
